---
title: "createStore — NexusStore Store Factory"
sidebarTitle: "createStore"
description: "createStore(initialState) creates a NexusStore store. Returns getState, subscribe, setState, and setMultiple. Must be called outside React components."
---
